...
❌ Horizontal (anti-pattern):
   Task 1: Create all Zustand stores
   Task 2: Create all API hooks
   Task 3: Create all UI components

✅ Vertical (correct):
   Task 1: User can create a task (store + API hook + form component)
   Task 2: User can view task list (API hook + list component + loading/error states)
   Task 3: User can mark task complete (optimistic update + component interaction)
```
