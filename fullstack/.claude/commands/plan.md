...
- A specification exists (`features/[feature-name]/SPEC.md` or described requirements)
...
Save to `features/[feature-name]/` directory (same folder as SPEC.md):

- `features/[feature-name]/plan.md` — Full planning document with context
- `features/[feature-name]/todo.md` — Actionable task checklist
